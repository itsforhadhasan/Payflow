...
import { ArrowDownLeft, Contact, User, Send, X, Clock } from 'lucide-react';
...
export default function RequestMoneyPage() {
    ...
    const quickContacts = [
        ...
        { name: 'Distributor B', number: '01900000002' },
        { name: 'New Client C', number: '01800000003' },
    ];
    ...
    return (
        <div className="min-h-screen bg-[#f8f9fa] dark:bg-[#0f172a] font-sans">
            <SubPageHeader title="Request Money" backLink="/dashboard/business" className="bg-indigo-600 dark:bg-indigo-700" />
            ...
            <div className="max-w-md mx-auto px-4 relative">
                <div className="bg-white dark:bg-[#1e293b] rounded-[2.5rem] p-8 shadow-xl shadow-gray-200/50 dark:shadow-none space-y-8">
                    ...
                    <div className="space-y-2">
                        <label className="text-xs font-bold text-gray-400 uppercase tracking-widest ml-1">Payer Number</label>
                        ...
                        <>
                            ...
                            >
                                <div className="flex justify-between items-center mb-6">
                                    <h3 className="text-lg font-bold text-gray-800 dark:text-white">Recent Contacts</h3>
                                ...
                                <div className="space-y-4 max-h-64 overflow-y-auto">
                                    {quickContacts.map((contact, i) => (
                                        <button
                                            key={i}
                                            onClick={() => { setPayer(contact.number); setShowContacts(false); }}
                                        ...
                                        >
                                            ...
                                            <div className="text-left">
                                                <p className="font-bold text-gray-800 dark:text-white group-hover:text-indigo-600">{contact.name}</p>
